...
# write.csv(results_test,paste0("../Processed_data/Data_2020_NULL_modules/2020_NN_results_test_modules_",Plot_i,".csv"))

}
# commented for security reasons

# new_wd <- paste0(dir_ini,"/","Processed_data/Data_2020_NULL_modules/")
# setwd(new_wd)
# 
# results_test_9 <- read_csv("2020_NN_results_test_modules_9.csv") %>% dplyr::select(-X1)
# results_test_8 <- read_csv("2020_NN_results_test_modules_8.csv") %>% dplyr::select(-X1)
# results_test_7 <- read_csv("2020_NN_results_test_modules_7.csv") %>% dplyr::select(-X1)
# results_test_6 <- read_csv("2020_NN_results_test_modules_6.csv") %>% dplyr::select(-X1)
# results_test_5 <- read_csv("2020_NN_results_test_modules_5.csv") %>% dplyr::select(-X1)
# results_test_4 <- read_csv("2020_NN_results_test_modules_4.csv") %>% dplyr::select(-X1)
# results_test_3 <- read_csv("2020_NN_results_test_modules_3.csv") %>% dplyr::select(-X1)
# results_test_2 <- read_csv("2020_NN_results_test_modules_2.csv") %>% dplyr::select(-X1)
# results_test_1 <- read_csv("2020_NN_results_test_modules_1.csv") %>% dplyr::select(-X1)
# 
# 
# results_test_new <- bind_rows(results_test_1,
#                               results_test_2,
#                               results_test_3,
#                               results_test_4,
#                               results_test_5,
...
#                               results_test_9)
# 
# write_csv(results_test_new,"2020_NN_results_test_modules.csv")



results_test <- read_csv(
  "Processed_data/Data_2020_NULL_modules/2020_NN_results_test_modules.csv")
...
L_real <- results_test %>% filter(OBS=="Real") %>% select(L_real)
m_real <- results_test %>% filter(OBS=="Real") %>% select(m_real)
